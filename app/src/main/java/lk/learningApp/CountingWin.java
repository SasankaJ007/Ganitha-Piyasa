...
public class CountingWin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_counting_win);
        ...
        bgMusic    =MediaPlayer.create(CountingWin.this,R.raw.win);
        ...
        navGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), CountingLevelBoard.class);
                startActivity(i);
                finish();
            }
        });
