...
public class SpeakingLevelBoard extends AppCompatActivity {


    List<NonSwipeRatingBar> ratingBarList = new ArrayList<>(15);
    CustomRatingBar r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,r13,r14,r15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_speaking_level_board);
        ...
        r1 = findViewById(R.id.level01);
        r2 = findViewById(R.id.level02);
        r3 = findViewById(R.id.level03);
        r4 = findViewById(R.id.level04);
        r5 = findViewById(R.id.level05);
        r6 = findViewById(R.id.level06);
        r7 = findViewById(R.id.level07);
        r8 = findViewById(R.id.level08);
        r9 = findViewById(R.id.level09);
        r10 = findViewById(R.id.level10);
        r11 = findViewById(R.id.level11);
        r12 = findViewById(R.id.level12);
        r13 = findViewById(R.id.level13);
        r14 = findViewById(R.id.level14);
        r15 = findViewById(R.id.level15);
       // ratingBar = findViewById(R.id.LevelR01); ratingBar.setNumStars(1);
        for (int i = 1; i <= 15; i++) {
        ...
        bgMusic = MediaPlayer.create(SpeakingLevelBoard.this,R.raw.levelboardsound);
        startMusic();
        ...
        View.OnClickListener cardClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentlyHighlightedCard != null) {
                    ...
                    currentlyHighlightedCard.setBackgroundColor(ContextCompat.getColor(SpeakingLevelBoard.this, android.R.color.white));
                    currentlyHighlightedCard.setBackground(ContextCompat.getDrawable(SpeakingLevelBoard.this, R.drawable.levelcorner));
                }
                ...
                if (v instanceof CardView) {
                    ...
                    clickedCard.setBackground(ContextCompat.getDrawable(SpeakingLevelBoard.this, R.drawable.levelgame01));
        ...
        getStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (LockLevels.getSelectedNumber(levelName) <= (selectedLevel+1)) {
                    Log.d("LevelSelected",levelName);
                    Intent i=new Intent(getApplicationContext(),speaking.class);
                    i.putExtra("selectedLevel",levelName);
                    startActivity(i);
                    currentlyHighlightedCard.setBackgroundColor(ContextCompat.getColor(SpeakingLevelBoard.this, android.R.color.white));
                    currentlyHighlightedCard.setBackground(ContextCompat.getDrawable(SpeakingLevelBoard.this, R.drawable.levelcorner));
                } else {
                    Toast.makeText(SpeakingLevelBoard.this,"Please select Unlocked Level!!",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void retrieveDataFromDatabase() {
        ...
        DocumentReference documentRef = FirebaseFirestore.getInstance().collection("SpeakingGame").document(userID);
