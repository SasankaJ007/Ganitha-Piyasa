...
public class CountingLevelBoard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_counting_level_board);
        ...
        bgMusic = MediaPlayer.create(CountingLevelBoard.this,R.raw.levelboardsound);
        startMusic();
        ...
        View.OnClickListener cardClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentlyHighlightedCard != null) {
                    ...
                    currentlyHighlightedCard.setBackgroundColor(ContextCompat.getColor(CountingLevelBoard.this, android.R.color.white));
                    currentlyHighlightedCard.setBackground(ContextCompat.getDrawable(CountingLevelBoard.this, R.drawable.levelcorner));
                }
                ...
                if (v instanceof CardView) {
                    ...
                    clickedCard.setBackground(ContextCompat.getDrawable(CountingLevelBoard.this, R.drawable.levelgame03));
        ...
        getStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (LockLevels.getSelectedNumber(levelName) <= (selectedLevel+1)) {
                    ...
                    Toast.makeText(CountingLevelBoard.this,"Please select Unlocked Level!!",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void retrieveDataFromDatabase() {
        ...
        DocumentReference documentRef = FirebaseFirestore.getInstance().collection("CountingGame").document(userID);
