...
public class SpeakingLose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_speaking_lose);


        bgMusic = MediaPlayer.create(SpeakingLose.this, R.raw.lose);
        startMusic();
