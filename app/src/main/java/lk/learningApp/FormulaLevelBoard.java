...
public class FormulaLevelBoard extends AppCompatActivity {
   ...
   // int star;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_formula_level_board);
        ...
        bgMusic = MediaPlayer.create(FormulaLevelBoard.this,R.raw.levelboardsound);
        startMusic();
        ...
        View.OnClickListener cardClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentlyHighlightedCard != null) {
                    ...
                    currentlyHighlightedCard.setBackgroundColor(ContextCompat.getColor(FormulaLevelBoard.this, android.R.color.white));
                    currentlyHighlightedCard.setBackground(ContextCompat.getDrawable(FormulaLevelBoard.this, R.drawable.levelcorner));
                }
                ...
                if (v instanceof CardView) {
                    ...
                    clickedCard.setBackground(ContextCompat.getDrawable(FormulaLevelBoard.this, R.drawable.levelgame04));
        ...
        getStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (LockLevels.getSelectedNumber(levelName) <= (selectedLevel+1)){
                    ...
                    Toast.makeText(FormulaLevelBoard.this,"Please select Unlocked Level!!",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void retrieveDataFromDatabase() {
        ...
        DocumentReference documentRef = FirebaseFirestore.getInstance().collection("LogicGame").document(userID);
